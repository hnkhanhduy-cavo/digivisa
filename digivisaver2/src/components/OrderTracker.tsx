            ...
            <div className="flex items-center justify-between">
              ...
              {orders.length > 0 && onClearAllOrders && (
                <button
                  ...
                  className="text-[10px] text-rose-600 hover:text-rose-700 font-extrabold cursor-pointer hover:underline transition-all uppercase tracking-wider"
                  title="Wipe out all orders in local storage"
                >
