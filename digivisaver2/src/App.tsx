...
export default function App() {
  const [userRole, setUserRole] = useState<'customer' | 'staff'>(() => {
    const saved = safeStorage.getItem('digivisa_user_role');
  ...
  const handleBookingSuccess = (newOrder: Order) => {
    ...
    triggerToast(`Booking ${newOrder.id} successfully completed & paid! Check your ticket below.`, 'success');
  };
