/**
 * Đầu mối liên hệ dùng chung.
 * Để RỖNG khi chưa có số/OA thật — UI sẽ tự ẩn nút thay vì mở link hỏng.
 */

/** Hotline WhatsApp dạng E.164, KHÔNG có dấu +. Ví dụ: '84901234567'. */
export const WHATSAPP_HOTLINE = '';
/** Link Zalo đầy đủ: số cá nhân 'https://zalo.me/84...' hoặc OA 'https://zalo.me/<oa_id>'. */
export const ZALO_CONTACT_URL = '';
/** Chuỗi hiển thị cho người đọc. Để rỗng nếu chưa có. */
export const HOTLINE_DISPLAY = '';
