        ...
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <nav className="flex items-center space-x-1 bg-slate-50 p-1 rounded-xl border border-slate-150/80">
            <button
              ...
              title={t.services}
              onClick={() => setActiveTab('services')}
              className={`flex items-center space-x-1 sm:space-x-1.5 px-2 py-1.5 sm:px-4 sm:py-2 rounded-lg text-xs sm:text-sm font-medium transition-all duration-200 cursor-pointer ${
                activeTab === 'services'
            ...
            <button
              ...
              className={`relative flex items-center space-x-1 sm:space-x-1.5 px-2 py-1.5 sm:px-4 sm:py-2 rounded-lg text-xs sm:text-sm font-medium transition-all duration-200 cursor-pointer ${
                activeTab === 'tracker'
                  ? 'bg-white text-indigo-600 border border-slate-200/80 shadow-sm font-semibold'
                  : 'text-slate-500 hover:text-slate-800 hover:bg-slate-100/50 border border-transparent'
              }`}
